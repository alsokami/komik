...
public class OilrefineryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public OilrefineryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KomikModMenus.OILREFINERY.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 143, 26) {
